...
package org.javaparser.symbolsolver.model.usages.typesystem;
...
public class WildcardUsageTest {
    ...
    public void testAsDescribe() {
        ...
        assertEquals("? super org.javaparser.symbolsolver.model.usages.typesystem.WildcardUsageTest.Foo", superFoo.describe());
        assertEquals("? super org.javaparser.symbolsolver.model.usages.typesystem.WildcardUsageTest.Bar", superBar.describe());
        assertEquals("? extends org.javaparser.symbolsolver.model.usages.typesystem.WildcardUsageTest.Foo", extendsFoo.describe());
        assertEquals("? extends org.javaparser.symbolsolver.model.usages.typesystem.WildcardUsageTest.Bar", extendsBar.describe());
    }
