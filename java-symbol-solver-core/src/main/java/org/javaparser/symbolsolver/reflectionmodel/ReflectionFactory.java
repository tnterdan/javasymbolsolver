...
import org.javaparser.symbolsolver.model.usages.typesystem.*;

import java.lang.reflect.*;

public class ReflectionFactory {
    public static org.javaparser.symbolsolver.model.usages.typesystem.Type typeUsageFor(Class<?> clazz, TypeSolver typeSolver) {
        if (clazz.isArray()) {
    ...
    public static org.javaparser.symbolsolver.model.usages.typesystem.Type typeUsageFor(java.lang.reflect.Type type, TypeSolver typeSolver) {
        if (type instanceof java.lang.reflect.TypeVariable) {
            ...
            return new org.javaparser.symbolsolver.model.usages.typesystem.TypeVariable(typeParameter);
