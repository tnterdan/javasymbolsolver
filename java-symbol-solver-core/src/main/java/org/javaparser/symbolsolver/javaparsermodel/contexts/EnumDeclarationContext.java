...
import org.javaparser.symbolsolver.javaparsermodel.declarations.JavaParserMethodDeclaration;
...
public class EnumDeclarationContext extends AbstractJavaParserContext<EnumDeclaration> {
    ...
    @Override
    public SymbolReference<org.javaparser.symbolsolver.model.declarations.MethodDeclaration> solveMethod(String name, List<Type> argumentsTypes, TypeSolver typeSolver) {
        List<org.javaparser.symbolsolver.model.declarations.MethodDeclaration> candidateMethods = new ArrayList<>();
        for (BodyDeclaration member : this.wrappedNode.getMembers()) {
